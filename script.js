...
for (const x of units) {
    ...
    <section id="unitSection${x.unit}" class="unit-section unit-section-${x.unit == 1 ? 'open' : 'close'}">
  <div class="display-flex mt-3">
  <input type="radio" ${x.unit == 1 ? 'checked' : ''}
    ...
    <div class="justify-content-end">
      <div class="col">
        ...
        <del class="row standard-price-value">$${pricePerUnit * x.unit} USD</del>
      </div>
    </div>
  </div>
